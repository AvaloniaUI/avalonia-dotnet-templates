...
Create-And-Build "avalonia.app" "AvaloniaApp" "C#" "av" "11.3.3" $binlog
...
Create-And-Build "avalonia.mvvm" "AvaloniaMvvm" "C#" "av" "11.3.3" $binlog
...
Create-And-Build "avalonia.xplat" "AvaloniaXplat" "C#" "av" "11.3.3" $binlog
...
Create-And-Build "avalonia.app" "AvaloniaApp" "F#" "av" "11.3.3" $binlog
...
Create-And-Build "avalonia.mvvm" "AvaloniaMvvm" "F#" "av" "11.3.3" $binlog
...
Create-And-Build "avalonia.xplat" "AvaloniaXplat" "F#" "av" "11.3.3" $binlog
