...
Create-And-Build "avalonia.app" "AvaloniaApp" "C#" "av" "11.0.4" $binlog
...
Create-And-Build "avalonia.mvvm" "AvaloniaMvvm" "C#" "av" "11.0.4" $binlog
...
Create-And-Build "avalonia.app" "AvaloniaApp" "F#" "av" "11.0.4" $binlog
...
Create-And-Build "avalonia.mvvm" "AvaloniaMvvm" "F#" "av" "11.0.4" $binlog
