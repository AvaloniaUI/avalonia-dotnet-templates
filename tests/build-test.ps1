...
Create-And-Build "avalonia.app" "AvaloniaApp" "C#" "av" "12.0.3" $binlog
...
Create-And-Build "avalonia.mvvm" "AvaloniaMvvm" "C#" "av" "12.0.3" $binlog
...
Create-And-Build "avalonia.xplat" "AvaloniaXplat" "C#" "av" "12.0.3" $binlog
...
Create-And-Build "avalonia.app" "AvaloniaApp" "F#" "av" "12.0.3" $binlog
...
Create-And-Build "avalonia.mvvm" "AvaloniaMvvm" "F#" "av" "12.0.3" $binlog
...
Create-And-Build "avalonia.xplat" "AvaloniaXplat" "F#" "av" "12.0.3" $binlog
